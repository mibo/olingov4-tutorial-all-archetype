...
public class DemoPrimitiveProcessor implements PrimitiveProcessor {
  ...
  private ServiceMetadata serviceMetadata;
	...
	/*
	 * In our example, the URL would be: http://localhost:8080/${artifactId}/${artifactId}.svc/Products(1)/Name
	 * and the response:
	 * {
	 *	  @odata.context: "${symbol_dollar}metadata${symbol_pound}Products/Name",
